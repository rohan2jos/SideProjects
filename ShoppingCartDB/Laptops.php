...
<body>
        ...
        <div class="container-fluid">
            <div>
                <ul class="nav navbar-nav">
                    ...
                    <li class="active"><a href="Laptops.php?user=<? echo $theUser ?>">Laptops</a></li>
    ...
    <br />
    <div id="mainDiv">
    <h1><center>Laptops we have<center></h1> 
    <br />
    <?php 
        if(isset($message)){ 
    ...
    <table class="table table-hover" style="width:100%"> 
        ...
        <?php 
            ...
            $sql="select * from Product p where p.producttypeid = '3'"; 
        ...
        ?> 
            <tr> 
                ...
                <td><a href="Laptops.php?page=products&action=add&id=<?php echo $row['id']?>&price=<? echo $row['price'] ?>&user=<? echo $theUser ?>">Add to cart</a></td> 
            </tr> 
        <?php 
